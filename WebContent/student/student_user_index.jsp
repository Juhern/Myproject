    ...
    <div class="pull-left">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td align="center"><%=student.getSex() %>
                </td>
                <td align="center"><%=student.getPosition() %>
                </td>
                <td align="center"><%=student.getClassname() %>
                </td>
                <td align="center"><%=student.getAddress() %>
                </td>
                <td align="center"><%=student.getPhone() %>
                </td>
