...
%>
    <tr>
    <td align="center"><%=testList.get(i).getId()%></td>
    <td align="center"><%=testList.get(i).getName()%></td>
    <td align="center"><%=testList.get(i).getAcho() %></td>
    <td align="center"><%=testList.get(i).getBcho() %></td>
    <td align="center"><%=testList.get(i).getCcho() %></td>
    <td>
            <select  name="<%=i%>">
