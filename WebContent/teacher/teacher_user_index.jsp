...
<div class="contain pull-left">
    ...
    <div class="pull-left">
        <table class="table table-hover">
            ...
            %>
            <tr>
                <td align="center"><%=teacher.getName()%>
                </td>
                <td align="center"><%=teacher.getAge()%>
                </td>
                <td align="center"><%=teacher.getSex() %>
                </td>
                <td align="center"><%=teacher.getPosition() %>
                </td>
                <td align="center"><%=teacher.getAddress() %>
                </td>
                <td align="center"><%=teacher.getPhone() %>
                </td>

                <td align="center">
                    <a href="..//TeachUpdateServlet?namestr=<%=namestring%>"
                       onclick='return window.confirm("This message will be changed. Are you sure？")'>
